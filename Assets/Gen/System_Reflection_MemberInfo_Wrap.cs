...
{
    public static class System_Reflection_MemberInfo_Wrap
    {
        ...
        private static IntPtr Constructor(IntPtr isolate, IntPtr info, int paramLen, long data)
        {
            try
            {
                ...
                Puerts.PuertsDLL.ThrowException(isolate, "invalid arguments to System.Reflection.MemberInfo constructor");
            }
            catch (Exception e)
            {
        ...
        private static void M_GetCustomAttributes(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as System.Reflection.MemberInfo;
                ...
                if (paramLen == 1)
                {
                    ...
                    if (argHelper0.IsMatch(Puerts.JsValueType.Boolean, null, false, false))
                    {
                        ...
                        var result = obj.GetCustomAttributes(Arg0);
                ...
                if (paramLen == 2)
                {
                        ...
                        && argHelper1.IsMatch(Puerts.JsValueType.Boolean, null, false, false))
                    {
                        ...
                        var result = obj.GetCustomAttributes(Arg0,Arg1);
                ...
                Puerts.PuertsDLL.ThrowException(isolate, "invalid arguments to GetCustomAttributes");
            }
            catch (Exception e)
            {
                Puerts.PuertsDLL.ThrowException(isolate, "c# exception:" + e.Message + ",stack:" + e.StackTrace);
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        private static void M_IsDefined(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as System.Reflection.MemberInfo;
                ...
                
                {
                    ...
                    
                    {
                        ...
                        var Arg0 = argHelper0.Get<System.Type>(false);
                        var Arg1 = argHelper1.GetBoolean(false);
                        var result = obj.IsDefined(Arg0,Arg1);
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        private static void M_GetCustomAttributesData(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as System.Reflection.MemberInfo;
                ...
                
                {
                    ...
                    
                    {
                        ...
                        var result = obj.GetCustomAttributesData();
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        private static void G_CustomAttributes(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as System.Reflection.MemberInfo;
                var result = obj.CustomAttributes;
                Puerts.ResultHelper.Set((int)data, isolate, info, result);
            }
            catch (Exception e)
            {
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        private static void G_MetadataToken(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as System.Reflection.MemberInfo;
                var result = obj.MetadataToken;
                Puerts.PuertsDLL.ReturnNumber(isolate, info, result);
            }
            catch (Exception e)
            {
            ...
            try
            {
                ...
                
                {
                    ...
                    
                    {
                        ...
                        var arg0 = argHelper0.Get<System.Reflection.MemberInfo>(false);
                        var arg1 = argHelper1.Get<System.Reflection.MemberInfo>(false);
        ...
        public static Puerts.TypeRegisterInfo GetRegisterInfo()
        {
            return new Puerts.TypeRegisterInfo()
            {
                ...
                Methods = new System.Collections.Generic.Dictionary<Puerts.MethodKey, Puerts.V8FunctionCallback>()
                {
                    ...
                    { new Puerts.MethodKey {Name = "GetCustomAttributes", IsStatic = false}, M_GetCustomAttributes },
                    
                    { new Puerts.MethodKey {Name = "IsDefined", IsStatic = false}, M_IsDefined },
                    
                    { new Puerts.MethodKey {Name = "GetCustomAttributesData", IsStatic = false}, M_GetCustomAttributesData },
                ...
                Properties = new System.Collections.Generic.Dictionary<string, Puerts.PropertyRegisterInfo>()
                {
                    ...
                    {"CustomAttributes", new Puerts.PropertyRegisterInfo(){ IsStatic = false, Getter = G_CustomAttributes, Setter = null} },
                    
                    {"MetadataToken", new Puerts.PropertyRegisterInfo(){ IsStatic = false, Getter = G_MetadataToken, Setter = null} },
